...
png(opt$ofile)
p + scale_y_discrete(breaks=slist,labels=names) + theme(axis.text.y=element_text(size=7)) + theme(axis.text.x=element_text(size=7,angle=-90,vjust=0.5)) + ylab("Cluster")
dev.off()
